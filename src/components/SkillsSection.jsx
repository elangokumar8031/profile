...
const ViteLogo = () => (
  <svg xmlns="http://www.w3.org/2000/svg" className="w-[28px] h-[28px] text-neutral-500 dark:text-neutral-400" viewBox="0 0 410 404" fill="none">
    <path d="M399.641 49.8055L216.593 392.179C212.872 399.138 202.915 399.138 199.195 392.179L16.1466 49.8055C11.9688 41.993 19.3878 33.1593 27.5028 36.2166L207.894 104.225L388.285 36.2166C396.4 33.1593 403.819 41.993 399.641 49.8055Z" fill="currentColor"/>
    <path d="M285.344 19.4623L207.894 104.225L130.444 19.4623C125.751 14.321 117.472 15.3413 114.153 21.4646L63.3182 115.228L204.184 378.694C205.801 381.717 209.987 381.717 211.604 378.694L352.469 115.228L301.635 21.4646C298.316 15.3413 290.036 14.321 285.344 19.4623Z" fill="currentColor" opacity="0.8"/>
  </svg>
)
...
const categories = [
  {
    ...
    direction: 'up',
    skills: [
      { icon: 'bxl-html5 text-neutral-500 dark:text-neutral-400', name: 'HTML' },
      { icon: 'bxl-css3 text-neutral-500 dark:text-neutral-400', name: 'CSS' },
      { icon: 'bxl-tailwind-css text-neutral-500 dark:text-neutral-400', name: 'Tailwind CSS' },
      { icon: 'bxl-javascript text-neutral-500 dark:text-neutral-400', name: 'JavaScript' },
      { icon: 'bxl-react text-neutral-500 dark:text-neutral-400', name: 'React JS' },
      { icon: 'bx-layer text-neutral-500 dark:text-neutral-400', name: 'Chakra UI' }
    ]
  },
  {
    title: 'Programming',
    direction: 'down',
    skills: [
      { icon: 'bxl-java text-neutral-500 dark:text-neutral-400', name: 'Java' },
      { icon: 'bx-code-curly text-neutral-500 dark:text-neutral-400', name: 'C' },
      { icon: 'bxl-python text-neutral-500 dark:text-neutral-400', name: 'Python' }
    ]
  },
  {
    title: 'Tools & Others',
    direction: 'up',
    skills: [
      { icon: 'bxl-git text-neutral-500 dark:text-neutral-400', name: 'Git' },
      { icon: 'bxl-github text-neutral-500 dark:text-neutral-400', name: 'GitHub' },
      { icon: 'bxl-redux text-neutral-500 dark:text-neutral-400', name: 'Redux' },
      { customIcon: <ViteLogo />, name: 'Vite' },
      { icon: 'bx-globe text-neutral-500 dark:text-neutral-400', name: 'APIs' }
    ]
  }
]
