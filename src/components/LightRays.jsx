...
/**
 * LightRays — WebGL spotlight/ray effect using OGL
 */
const LightRays = ({
...
void main() {
  ...
  /* ── Reactive uniform updates (no re-init needed) ── */
  useEffect(() => {
  ...
  return (
    <div
      ref={containerRef}
      className={className}
      style={{ width: '100%', height: '100%', pointerEvents: 'none', overflow: 'hidden', position: 'relative' }}
    />
  );
};
